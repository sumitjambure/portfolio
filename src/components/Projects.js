        ...
        <section id="projects"
            ...
            <div className="p-10 bg-emerald-200 flex flex-col justify-center items-center
                ...
                <div className="flex flex-col align-center mx-auto gap-4 justify-center flex-1">
                    ...
                    <p>
                        This is a project built on react which helpsThis app helps teams communicate in real time.
                        It uses technology like Node.js, Express.js, Angular, and Socket.io
                        to make sure conversations are secure and happen instantly.

                        This is great for working together, especially when teams are in different places.
                    </p>
                </div>
            </div>
